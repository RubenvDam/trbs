...
INPUT_DICT_BEERWISER = {
    ...
    "generic_text_element_value": np.array(
        [
            ...
            "The outputs upon which the decision makers will base their decision. Key outputs are often referred to as KPIs. Key outputs are grouped into themes.",
            "Decision makers options are formulated by assigning a single value to all internal variable inputs. These inputs can be formulated and determined by the decision makers.",
            "Each external variable input can be thought of as a single aspect of external uncertainty affecting the outcome of the decision in scope. A scenario is defined by assigning a single value to all external variable inputs.",
            ...
            "The table below shows the key output values per option, based on the selected scenario. The option with the highest weighted appreciation is highlighted.",
            "The chart below shows the weighted appreciations per option, grouped into scenarios. The used scenario weights are displayed in the pie chart on the right.",
    ...
    "case_text_element_value": np.array(
        [
            "Like other brewers, Beerwiser uses a significant amount of water during the heating process and for cleaning bottles and kegs. On average, Beerwiser uses five pints of water to produce one pint of beer. In comparison, competitors such as Heineken and Carlsberg used 4.8 and 3.3 pints of water per pint of beer, respectively, in 2012 (Appleyard, n.d.). Additionally, injuries among brewery workers reported to the Bureau of Labor Statistics have been increasing, rising from 160 in 2011 to 530 in 2014 (Roth, 2016). This issue is also present at our brewery. The strategic challenge we face is determining which investments will lead to a more sustainable brewing process. We aim to create transparency for our key stakeholders regarding the potential value to our organization from reducing water consumption and workplace accidents."
        ]
    ),
    ...
    "fixed_input_value": np.array([500, 51, 7500000, 15000000, 0.05, 0.48, 0.95, 0.9, 300000, 0.5, 1.0, 1.0, 275000]),
